Contributing to Franc Core
==================================

The Franc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Franc Core project, and is not to be
confused with overall Franc Network Protocol consensus changes.

Whether a pull request is merged into Franc Core rests with the project merge
...
Patches that change Franc consensus rules are considerably more involved than
...
Where a patch set proposes to change the Franc consensus, it must have been
...
The project leader is the release manager for each Franc Core release.
