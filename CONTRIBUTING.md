Contributing to French Core
==================================

The French Core project operates an open contributor model where anyone is
...
The following applies to code changes to the French Core project, and is not to be
confused with overall French Network Protocol consensus changes.

Whether a pull request is merged into French Core rests with the project merge
...
Patches that change French consensus rules are considerably more involved than
...
Where a patch set proposes to change the French consensus, it must have been
...
The project leader is the release manager for each French Core release.
