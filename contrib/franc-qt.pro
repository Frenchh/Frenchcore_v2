...
RESOURCES += src/qt/franc.qrc src/qt/franc_locale.qrc

TRANSLATIONS += src/qt/locale/franc_bg.ts \
                src/qt/locale/franc_de.ts \
                src/qt/locale/franc_en.ts \
                src/qt/locale/franc_es.ts \
                src/qt/locale/franc_fi.ts \
                src/qt/locale/franc_fr.ts \
                src/qt/locale/franc_it.ts \
                src/qt/locale/franc_ja.ts \
                src/qt/locale/franc_pl.ts \
                src/qt/locale/franc_pt.ts \
                src/qt/locale/franc_ru.ts \
                src/qt/locale/franc_sk.ts \
                src/qt/locale/franc_sv.ts \
                src/qt/locale/franc_vi.ts \
                src/qt/locale/franc_zh_CN.ts \
                src/qt/locale/franc_zh_TW.ts
