...
#   c) node1 mines 32 blocks, so now node 0 has 500000FRC, node 1 has 4250FRC, node2 has none.
#   d) node0 sends 601 FRC to node2, in two transactions (301 FRC, then 300 FRC).
