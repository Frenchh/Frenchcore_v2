...
/** Utility functions used by the French Qt UI.
 */
namespace GUIUtil
{
...
// Render FRC addresses in monospace font
...
// Parse "french:" URI into recipient object, return true on successful parsing
