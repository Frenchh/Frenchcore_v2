...
// FRC: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_7_FRANCNODE_SCANNING) r = SPORK_7_FRANCNODE_SCANNING_DEFAULT;
        if (nSporkID == SPORK_8_FRANCNODE_PAYMENT_ENFORCEMENT) r = SPORK_8_FRANCNODE_PAYMENT_ENFORCEMENT_DEFAULT;
        if (nSporkID == SPORK_9_FRANCNODE_BUDGET_ENFORCEMENT) r = SPORK_9_FRANCNODE_BUDGET_ENFORCEMENT_DEFAULT;
        if (nSporkID == SPORK_10_FRANCNODE_PAY_UPDATED_NODES) r = SPORK_10_FRANCNODE_PAY_UPDATED_NODES_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_7_FRANCNODE_SCANNING") return SPORK_7_FRANCNODE_SCANNING;
    if (strName == "SPORK_8_FRANCNODE_PAYMENT_ENFORCEMENT") return SPORK_8_FRANCNODE_PAYMENT_ENFORCEMENT;
    if (strName == "SPORK_9_FRANCNODE_BUDGET_ENFORCEMENT") return SPORK_9_FRANCNODE_BUDGET_ENFORCEMENT;
    if (strName == "SPORK_10_FRANCNODE_PAY_UPDATED_NODES") return SPORK_10_FRANCNODE_PAY_UPDATED_NODES;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_7_FRANCNODE_SCANNING) return "SPORK_7_FRANCNODE_SCANNING";
    if (id == SPORK_8_FRANCNODE_PAYMENT_ENFORCEMENT) return "SPORK_8_FRANCNODE_PAYMENT_ENFORCEMENT";
    if (id == SPORK_9_FRANCNODE_BUDGET_ENFORCEMENT) return "SPORK_9_FRANCNODE_BUDGET_ENFORCEMENT";
    if (id == SPORK_10_FRANCNODE_PAY_UPDATED_NODES) return "SPORK_10_FRANCNODE_PAY_UPDATED_NODES";
