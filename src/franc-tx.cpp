...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Franc Core franc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  franc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded franc transaction") + "\n" +
                               "  franc-tx [options] -create [commands]   " + _("Create hex-encoded franc transaction") + "\n" +
                               "\n";
