...
In order to support loading of multiple wallets in french-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is french.cpp.
...
Changes to french.cpp
----------------------
french.cpp is the entry point into french-qt, and as such, will require some minor modifications to provide hooks for
