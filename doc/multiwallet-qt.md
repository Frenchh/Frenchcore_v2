...
In order to support loading of multiple wallets in franc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is franc.cpp.
...
Changes to franc.cpp
----------------------
franc.cpp is the entry point into franc-qt, and as such, will require some minor modifications to provide hooks for
